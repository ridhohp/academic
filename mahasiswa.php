...
<table width="50%" class="table table-hover">
  ...
  <tr>
    ...
    <td><a href="aksi_mahasiswa.php?page=hapus&id=<?php echo $data[0]; ?>" onclick="return confirm ('Yakin Ingin Hapus Data')" class="btn btn-danger"> HAPUS</a> | <a href="index.php?p=mahasiswa&page=edit&id=<?php echo $data[0]; ?>"  class="btn btn-warning"> EDIT </a></td>
  </tr>
  <?php
  $no++;
  }
    ...
    <tr>
      ...
      <td><select name="prodi" id="prodi" class="form control">
		<option selected="">--Pilih Prodi--</option>
			<?php
				$result1 =mysql_query("select * from prodi");
